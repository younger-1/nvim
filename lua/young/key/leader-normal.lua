local mappings = {
  ...
  l = {
    ...
    ['<C-q>'] = { '<cmd>lua vim.diagnostic.setqflist()<cr>', 'Diagnostics quickfix' },
    ['<C-z>'] = { '<cmd>lua vim.diagnostic.setloclist()<cr>', 'Diagnostics locList' },
  ...
  p = {
    ...
    b = { '<cmd>lua require("young.plugin-loader").rollback()<cr>', 'Rollback' },
  ...
  s = {
    ...
    ['<C-z>'] = { '<cmd>Telescope loclist<cr>', 'LocList' },
  ...
  x = {
    ...
    ['<C-z>'] = { '<cmd>Trouble loclist<cr>', 'LocList' },
    ...
    [' '] = { '<cmd>Trouble workspace_diagnostics<cr>', 'Diagnostics(All)' },
  },
  y = {
    name = '+young',
    b = {
