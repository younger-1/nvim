...
return {
  ...
  r = {
    name = '+replace',
    f = { lua "lua require('spectre').open_file_search()", 'Replace buffer' },
    r = { lua "lua require('spectre').open()", 'Replace' },
    w = { lua "lua require('spectre').open_visual({select_word=true})", 'Replace word' },
  },
  s = {
    name = '+search',
    ...
    P = { cmd 'Telescope pickers', '<Pickers>' },
    R = { cmd 'Telescope reloader', 'Reload module' },
