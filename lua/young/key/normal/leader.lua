...
return {
  ...
  g = {
    ...
    d = {
      ...
      l = { cmd 'DiffviewFileHistory', 'All commits' },
      f = { cmd 'DiffviewFileHistory % --follow', 'File commits' },
      L = { cmd 'DiffviewLog', 'Log' },
      --
      a = { ':DiffviewFileHistory --author=', 'All commits (author)' },
      m = { ':DiffviewFileHistory --grep=', 'All commits (log message)' },
      c = { cmd 'DiffviewFileHistory --base=LOCAL', 'All commits (compare to local)' },
      u = { cmd 'DiffviewFileHistory --reverse', 'All commits (reverse)' },
      y = { cmd 'DiffviewFileHistory --merges', 'All commits (merge)' },
      Y = { cmd 'DiffviewFileHistory --no-merges', 'All commits (no merge)' },
      --
      A = { ':DiffviewFileHistory % --follow --author=', 'File commits (author)' },
      M = { ':DiffviewFileHistory % --follow --grep=', 'File commits (log message)' },
      C = { cmd 'DiffviewFileHistory % --follow --base=LOCAL', 'File commits (compare to local)' },
      U = { cmd 'DiffviewFileHistory % --follow --reverse', 'File commits (reverse)' },
      r = { ':DiffviewFileHistory -L,:<Left><Left>', 'File commits (range)' },
      b = { ':DiffviewFileHistory -L::<Left>', 'File commits (func)' },
    },
    h = {
      name = '+github',
