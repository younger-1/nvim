-- @see: <https://github.com/JoosepAlviste/dotfiles/blob/a15d8470347fd9b198598b817049265d02d66f07/config/nvim/lua/j/file_info/functions.lua>
...
function M.setup()
  ...
  local lsp_client_names = table.concat(
    vim.tbl_map(function(client)
      return client.name
    end, vim.tbl_values(vim.lsp.get_active_clients { bufnr = 0 })),
    ', '
  )
