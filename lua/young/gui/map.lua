...
M.done = function()
  nmap('<F8>', "<Cmd>lua require'young.gui.map'.adjust_fontsize(-1)<CR>")
  -- nmap('<S-F9>', "<Cmd>lua require'young.gui.map'.adjust_fontsize(-1)<CR>")
  nmap('<F9>', "<Cmd>lua require'young.gui.map'.adjust_fontsize(1)<CR>")

  nmap('<F10>', "<Cmd>lua require'young.gui.map'.switch_font()<CR>")

  nmap('<F11>', "<Cmd>lua require'young.gui.map'.toggle_fullscreen()<CR>")

  nmap('<S-F12>', "<Cmd>lua require'young.gui.map'.adjust_transparency(-1)<CR>")
  nmap('<F12>', "<Cmd>lua require'young.gui.map'.adjust_transparency(1)<CR>")
end
