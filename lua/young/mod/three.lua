...
vim.keymap.set('n', '<leader>h<leader>', three.wrap(three.next, { delta = 100 }), { desc = 'Jump to last buffer' })
vim.keymap.set('n', '<leader>hq', three.smart_close, { desc = 'Close window or buffer' })
vim.keymap.set('n', '<leader>hc', three.close_buffer, { desc = 'Close buffer' })
vim.keymap.set('n', '<leader>hh', three.hide_buffer, { desc = 'Hide buffer' })
vim.keymap.set('n', '<leader>hp', three.toggle_pin, { desc = 'Pin buffer' })
vim.keymap.set('n', '<leader>ht', three.clone_tab, { desc = 'Clone tab' })
...
vim.keymap.set('n', '<leader>hg', three.open_project, { desc = 'Find project' })
vim.keymap.set('n', '<leader>hd', three.remove_project, { desc = 'Delete project' })
